 ...
 * @return string
 */
$campaignCallPanelContent = function () use ($templates, $campaignCall, $selectedTargetLists, $listSelectHTML) {
    ob_start(); ?>
...
<?= (new UIPanel('Editar campanha da Caixa', $campaignCallPanelContent()))->display(); ?><br/>
