    ...
    <table class="templateForm">
        ...
        <tr>
            <td colspan="2"><?php echo s('Content of the template.') ?>
                ...
                <?php foreach ($GLOBALS['plugins'] as $pluginname => $plugin) {
                    if (method_exists($plugin, 'hookCaixaContentOfTheTemplateOptionalLine')) {
                        print '<br/>' . $plugin->hookCaixaContentOfTheTemplateOptionalLine();
                    }
                } ?>
